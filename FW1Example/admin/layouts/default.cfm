						...
						<ul class="nav">
							<li class="<cfif rc.action contains 'admin:main'>active</cfif>">
								...
								<ul class="dropdown-menu">
                                    ...
                                    <li class="<cfif rc.action contains 'admin:main.sayHello'>active</cfif>">
								        <a href="#buildURL('admin:main.sayHello')#"><i class="icon-info-sign"></i> Form Example</a>
							         </li>
									 <!--- Call to service starts here... --->
                                     <li class="<cfif rc.action contains 'admin:main.callService'>active</cfif>">
								        <a href="#buildURL('admin:main.callService')#"><i class="icon-book"></i> Service Example</a>
							         </li>
								</ul>
							</li>
